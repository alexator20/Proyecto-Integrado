		...
		<nav class="navbar navbar-expand-lg bg-dark lateral" data-bs-theme="dark">
			<div class="container-fluid">
				<div class="navbar-brand" style="padding-left: 25px;" href="#">
					<img src="./Assets/imgs/logoEmpresa.jpeg" alt="Logo" width="60" height="60" class="d-inline-block align-text-top">
				</div>
	...
	<div class="container-fluid">
			...
			<div class="container-fluid d-flex justify-content-center">
				<table>
					...
					<?php
					$sql = "SELECT SUM(precio) AS total_ventas
					FROM ticket
					JOIN producto_servido ON ticket.cod_ticket = producto_servido.cod_ticket
					JOIN producto ON producto_servido.cod_producto = producto.cod_producto
					WHERE fecha = CURDATE();";
					...
					while ($mostrar = mysqli_fetch_array($result)) {
						...
						<tr>
							...
							<td><?php echo $mostrar['num_mesa'] ?></td>
